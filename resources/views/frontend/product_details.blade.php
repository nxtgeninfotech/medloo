                                        ...
                                        @if(is_array(json_decode($detailedProduct->photos)) && count(json_decode($detailedProduct->photos)) > 0)
                                            <div class="product-gal-img text-center">
                                                <img src="{{ asset('frontend/images/placeholder.jpg') }}"
                                                     ...
                                                     data-src="{{ asset(json_decode($detailedProduct->photos)[0]) }}"
                                                     xoriginal="{{ asset(json_decode($detailedProduct->photos)[0]) }}"/>
                                            </div>
                                    ...
                                    <div class="product-details-content">
                                        <div class="row">
                                            <div class="col-10 pr-2">
                                                ...
                                                <div class="product-composition">
                                                    {{ __($detailedProduct->composition) }}
                                                </div>
                                                <div class="product-manufcturer">
                                                    {{ __("Stadmed Pvt Ltd") }}
                                                </div>
                                                <div class="product-customer-review">
                                                    ...
                                                    <div class="riview-count d-inline">
                                                        <a class="text-dark" href="#"
                                                           title="Product Total Review">({{ $total }} {{__('reviews')}}
                                                            )</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-2 pl-2">
                                                <div class="product-brand">
                                                    <img
                                                        src="https://images.latintimes.com/sites/latintimes.com/files/styles/full/public/2019/12/05/samsung-logo.jpg"
                                        ...
                                        <div class="row no-gutters mt-3">
                                            <div class="col-lg-6 align-self-center">
                                                @if(home_price($detailedProduct->id) != home_discounted_price($detailedProduct->id))
                                                    <div class="product-price">
                                                        <h3 class="text-primary"><span class="currency-symbol"></span>
                                                            {{ home_discounted_price($detailedProduct->id) }}
                                                            <span
                                                                class="product-piece">/ {{ $detailedProduct->unit }}</span>
                                                        </h3>
                                                    </div>
                                                    <div class="product-price-info">
                                                            <span class="product-mrp-price">MRP
                                                                <strike>
                                                                    <span class="currency-symbol">&#8377</span>
                                                                    <del>
                                                        ...
                                                        <span class="product-save-price">Save <span
                                            ...
                                            <div class="col-lg-6 d-flex flex-column">
                                                ...
                                                @endphp
                                                @if ($qty > 0)
                                                    <div class="product-stock-status in-stock"><i
                                                            class="fa fa-check-square text-green"></i> {{__('In Stoke')}}
                                                    </div>
                                                @else
                                                    <div class="product-stock-status out-of-stock"><i
                                                            class="fa fa-times-circle text-danger"></i> {{__('Out of Stock')}}
                                                    </div>
                                                @endif
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-append">
                                                            <button class="btn btn-primary" type="button"
                                                                    onclick="checkServiceability({{ $detailedProduct->id }})"
                                                            > check
                                                            </button>
                                                        </div>
                                                    </div>
                                                ...
                                                @foreach (json_decode($detailedProduct->choice_options) as $key => $choice)
                                                    <div class="row no-gutters mt-3">
                                                        <div class="col-lg-1 col-2">
                                                            <div
                                                                class="mt-2 strong-600">{{ \App\Attribute::find($choice->attribute_id)->name }}
                                                                :
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="product-color d-flex">
                                                            <ul class="list-inline checkbox-color mb-0">
                                                                @foreach (json_decode($detailedProduct->colors) as $key => $color)
                                                                    <li>
                                                                        <input type="radio"
                                                                               id="{{ $detailedProduct->id }}-color-{{ $key }}"
                                                        ...
                                                        <div class="input-group input-group--style-2 pr-3"
                                                             style="width: 160px;">
                                                                <span class="input-group-btn">
                                                                    <button class="btn btn-number btn-primary"
                                                ...
                                                <div class="col-lg-6 align-self-center text-right">
                                                    <div class="d-table width-100">
                                                        <div class="d-table-cell">
                                                            ...
                                                            @if ($qty > 0)
                                                                <button type="button"
                                                                        class="btn btn-secondary btn-icon-left strong-700 hov-bounce hov-shaddow buy-now"
                                                                        onclick="buyNow()">
                                                                    <i class="la la-shopping-cart"></i> {{__('Buy Now')}}
                                                                </button>
                                                                <button type="button"
                                                                        class="btn btn-primary c-white btn-icon-left strong-700 hov-bounce hov-shaddow ml-2 add-to-cart"
                                                                        onclick="addToCart()">
                                                                    <i class="la la-shopping-cart"></i>
                                                                    <span
                                                                        class="d-none d-md-inline-block"> {{__('Add to cart')}}</span>
                                                                </button>
                                                            @else
                                                                <button type="button"
                                                                        class="btn btn-styled btn-base-3 btn-icon-left strong-700"
                                                                        disabled>
                                        ...
                                        <div class="row no-gutters mt-3">
                                            <div class="col-lg-12">
                                                <div class="product-offer-code text-center">
                                                    <p class="m-0 p-0">10% Off On This Item - Use Voucher Code <span
                                                            class="offer-code">MEDLOO10</span></p>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="row no-gutters mt-2">
                                            <div class="col-lg-12">
                                                <div class="product-offer-banner">
                                                    <img src="https://medicana.co.in/images/home-banner.jpg"
                    ...
                    <div class="seller-info-box mb-3">
                        <div class="sold-by position-relative">
                            ...
                            @if($detailedProduct->added_by == 'seller' && \App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
                                <a href="{{ route('shop.visit', $detailedProduct->user->shop->slug) }}"
                                   class="name d-block">{{ $detailedProduct->user->shop->name }}
                                    @if ($detailedProduct->user->seller->verification_status == 1)
                        ...
                        <div class="row no-gutters align-items-center">
                            @if($detailedProduct->added_by == 'seller')
                                <div class="col">
                                    <a href="{{ route('shop.visit', $detailedProduct->user->shop->slug) }}"
                                       class="d-block store-btn">{{__('Visit Store')}}</a>
                                </div>
                                <div class="col">
                                                ...
                                                <div class="p-3">
                                                    ...
                                                    <div class="clearfix">
                                                        ...
                                                        @if (\App\Addon::where('unique_identifier', 'club_point')->first() != null && \App\Addon::where('unique_identifier', 'club_point')->first()->activated)
                                                            <div
                                                                class="float-right club-point bg-soft-base-1 border-light-base-1 border">
                                                                {{ __('Club Point') }}:
                                                                <span
                                                                    class="strong-700 float-right">{{ $related_product->earn_point }}</span>
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
                    ...
                    <div class="modal-body gry-bg px-3 pt-3">
                        <div class="form-group">
                            <input type="text" class="form-control mb-3" name="title"
                                   value="{{ $detailedProduct->name }}" placeholder="Product Name" required>
                        </div>
                        <div class="form-group">
                            <textarea class="form-control" rows="8" name="message" required
                                      placeholder="Your Question">{{ route('product', $detailedProduct->slug) }}</textarea>
                        </div>
                    </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function checkServiceability(product_id) {
            $.ajax({
                type: "post",
                url: '{{ route('check.courier.serviceability') }}',
                data: {
                ...
                success: function (Response) {
                    if (Response.status == true) {
                        ...
                        showFrontendAlert('danger', Response.message);
                    }
                }
            })
        }
