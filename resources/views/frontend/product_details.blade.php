                                                ...
                                                <div class="col-10 pr-2">
                                                    ...
                                                    <div class="product-customer-review">
                                                        ...
                                                        <div class="riview-count d-inline">
                                                            <a class="text-dark" href="#" title="Product Total Review">({{ $total }} {{__('reviews')}})</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    @if(home_price($detailedProduct->id) != home_discounted_price($detailedProduct->id))
                                                        <div class="product-price">
                                                            <h3 class="text-primary"><span class="currency-symbol"></span> 
                                                             ...
                                                             <span class="product-piece">/ {{ $detailedProduct->unit }}</span></h3>
                                                        </div>
                                                        <div class="product-price-info">
                                                            ...
                                                            <span class="product-save-price">Save <span class="currency-symbol"></span>
                                                            1500
                                                            </span>
                                                        </div>
                                                    @else
                                                    ...
                                                    @foreach (json_decode($detailedProduct->choice_options) as $key => $choice)
                                                        <div class="row no-gutters mt-3">
                                                            <div class="col-lg-1 col-2">
                                                                 <div class="mt-2 strong-600">{{ \App\Attribute::find($choice->attribute_id)->name }}:</div>
                                                            </div>
