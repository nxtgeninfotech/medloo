    ...
    function signUpModal(redirectURL = null) {
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response == "true") {
                    let path  = '<?php echo e(route("order-with-prescription")); ?>';
            ...
            <div class="row mx-0">
                <div class="col-lg-6 col-md-6 text-center d-flex align-items-center bg-primary bg-img">
                    <div class="signup-leftside text-center">
                        <img src="<?php echo e(asset('uploads/image/drug.png')); ?>" class="img-fluid w-25 mb-5">
                        <div class="title">
                            <h3 class="heading-5 strong-600 mb-4 text-white">
                                <?php echo e(__('Health Related Queries?')); ?>

                            </h3>
                            <p class="text-white"> <?php echo e(__('Get medicine information, order medicines, book lab tests and consult doctors online from the comfort of your home.')); ?></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="signup-rightside">
                        ...
                        <div id="LoginModel">
                            <div class="title">
                                ...
                                <p>
                                    <small><?php echo e(__('Please enter your Mobile number to receive One Time Password (OTP)')); ?></small>
                                </p>
                            </div>
...
<?php /**PATH /var/www/html/per/medloo/resources/views/auth/modal.blade.php ENDPATH**/ ?>