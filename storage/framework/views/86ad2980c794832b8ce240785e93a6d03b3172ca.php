...
<?php if(\App\Language::where('code', Session::get('locale', Config::get('app.locale')))->first()->rtl == 1): ?>
    ...
    <?php else: ?>
        ...
        <!-- Favicon -->
            ...
            <!-- Icons -->
            <link rel="stylesheet" href="<?php echo e(asset('frontend/css/font-awesome.min.css')); ?>" type="text/css" media="none"
                  onload="if(media!='all')media='all'">
            <link rel="stylesheet" href="<?php echo e(asset('frontend/css/line-awesome.min.css')); ?>" type="text/css" media="none"
                  onload="if(media!='all')media='all'">

            <link type="text/css" href="<?php echo e(asset('frontend/css/bootstrap-tagsinput.css')); ?>" rel="stylesheet"
                  media="none" onload="if(media!='all')media='all'">
            <link type="text/css" href="<?php echo e(asset('frontend/css/jodit.min.css')); ?>" rel="stylesheet" media="none"
                  onload="if(media!='all')media='all'">
            <link type="text/css" href="<?php echo e(asset('frontend/css/sweetalert2.min.css')); ?>" rel="stylesheet" media="none"
                  onload="if(media!='all')media='all'">
            <link type="text/css" href="<?php echo e(asset('frontend/css/slick.css')); ?>" rel="stylesheet" media="all">
            <link type="text/css" href="<?php echo e(asset('frontend/css/xzoom.css')); ?>" rel="stylesheet" media="none"
                  onload="if(media!='all')media='all'">
            <link type="text/css" href="<?php echo e(asset('frontend/css/jssocials.css')); ?>" rel="stylesheet" media="none"
                  onload="if(media!='all')media='all'">
            <link type="text/css" href="<?php echo e(asset('frontend/css/jssocials-theme-flat.css')); ?>" rel="stylesheet"
                  media="none" onload="if(media!='all')media='all'">
            <link type="text/css" href="<?php echo e(asset('frontend/css/intlTelInput.min.css')); ?>" rel="stylesheet" media="none"
                  onload="if(media!='all')media='all'">
            <link type="text/css" href="<?php echo e(asset('css/spectrum.css')); ?>" rel="stylesheet" media="none"
                  onload="if(media!='all')media='all'">
            ...
            <link type="text/css" href="<?php echo e(asset('frontend/css/custom.css')); ?>" rel="stylesheet" media="all">
        ...
        <!-- color theme -->
            <link href="<?php echo e(asset('frontend/css/colors/'.\App\GeneralSetting::first()->frontend_color.'.css')); ?>"
        ...
        <div class="body-wrap shop-default shop-cards shop-tech gry-bg">
            ...
            <?php echo $__env->make('auth.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /var/www/html/per/medloo/resources/views/frontend/layouts/app.blade.php ENDPATH**/ ?>